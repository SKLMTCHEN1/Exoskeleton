...
*************************************************************************/			 		 
		if (kneeAngle_raw>10||kneeAngle_raw<-10)	
		{
			temp_current = -1000;
			temp_current2 = 1000;			//the other leg is in index=4
		}
		else 
		{
			temp_current = 1000;
			temp_current2 = -1000;			//the other leg is in index=6     hip-->Netural knee-->back
		}			
